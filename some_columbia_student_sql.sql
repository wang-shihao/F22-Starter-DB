 ...
 */
 insert into columbia_students (last_name, first_name, middle_name, email, guid, school_code)
    values ("Wang", "Shihao", "None", "sw3567@columbia.edu", "sw3567", "SEAS");

select * from columbia_students where first_name="Shihao";
